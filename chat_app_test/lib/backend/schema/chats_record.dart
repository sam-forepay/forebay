...
abstract class ChatsRecord implements Built<ChatsRecord, ChatsRecordBuilder> {
  ...
  @BuiltValueField(wireName: 'chat_Icon')
  String? get chatIcon;

  String? get groupName;

  @BuiltValueField(wireName: 'chat_name')
  DocumentReference? get chatName;
  ...
  static ChatsRecord fromAlgolia(AlgoliaObjectSnapshot snapshot) => ChatsRecord(
        (c) => c
          ...
          ..chatIcon = snapshot.data['chat_Icon']
          ..groupName = snapshot.data['groupName']
          ..chatName = safeGet(() => toRef(snapshot.data['chat_name']))
